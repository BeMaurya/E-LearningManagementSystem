                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    <div class="chart chart1" data-percent="<?php echo $count_reg_teacher; ?>"><?php echo $count_reg_teacher; ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart2" data-percent="<?php echo $count_teacher; ?>"><?php echo $count_teacher ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart3" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart4" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart5" data-percent="<?php echo $count_class; ?>"><?php echo $count_class; ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart6" data-percent="<?php echo $count_file; ?>"><?php echo $count_file; ?></div>
                                ...
                                <div class="span3">
                                    <div class="chart chart7" data-percent="<?php echo $count_subject; ?>"><?php echo $count_subject; ?></div>
